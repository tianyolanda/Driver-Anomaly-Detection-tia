...
import argparse
from test_onemode import get_normal_vector, split_acc_diff_threshold, cal_score
...
from models import resnet, shufflenet, shufflenetv2, mobilenet, mobilenetv2, efficientnet, mobilenetv2se, resnetse
import ast
import numpy as np
...
def parse_args():
    ...
    parser.add_argument('--model_id', default='efficientnet-b0', type=str, help='model id for efficientnet')
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        if args.model_type == 'resnet':
            ...
            model_head = resnetse.ProjectionHead(args.feature_dim, args.model_depth)
            ...
            model_head = efficientnet.ProjectionHead(args.feature_dim)
        elif args.model_type == 'mobilenetv2se':
            model_head = mobilenetv2se.ProjectionHead(args.feature_dim)
        if args.use_cuda:
            model_head.cuda()
        ...
        resume_path_front_ir = './checkpoints/best_model_' + args.model_type + '_front_depth.pth'
        resume_path_top_d = './checkpoints/best_model_' + args.model_type + '_front_depth.pth'
        resume_path_top_ir = './checkpoints/best_model_' + args.model_type + '_front_depth.pth'
        ...
        #                                         args.feature_dim,
        #                                         args.use_cuda)
        normal_vec_front_ir = normal_vec_front_d
        ...
        #                                      args.feature_dim,
        #                                      args.use_cuda)
        normal_vec_top_d = normal_vec_front_d
        ...
        #                                       args.feature_dim,
        #                                       args.use_cuda)
        normal_vec_top_ir = normal_vec_front_d
        ...
        for mode, mode_name in hashmap.items():
            ...
            best_acc, best_threshold, AUC = evaluate(score, gt, True)
            print(
