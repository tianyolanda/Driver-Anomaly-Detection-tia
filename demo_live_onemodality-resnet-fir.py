...
import os
from models import shufflenet, shufflenetv2, resnet, mobilenetv2, resnetse
...
show_which = 'front_IR'  # show which view or modalities: {'front_depth', 'front_IR', 'top_depth', 'top_IR'}
threshold = 0.7  # the threshold
...
model_front_ir = resnetse.resnet18(
...
resume_path_front_ir = './checkpoints/best_model_resnetse_front_IR.pth'
...
for batch, data_ori in enumerate(zip(test_loader_front_ir)):
    # print(data1[0])
