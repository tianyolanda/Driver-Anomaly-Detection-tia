...
from models import shufflenet, shufflenetv2, resnet, mobilenet, mobilenetv2, efficientnet, mobilenetv2se, resnetse
from utils import _construct_depth_model

def generate_model(args):
    assert args.model_type in ['resnet', 'resnetse', 'shufflenet', 'shufflenetv2', 'mobilenet', 'mobilenetv2','efficientnet','mobilenetv2se']
