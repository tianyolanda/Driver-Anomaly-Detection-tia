...
from models import resnet, resnetse, shufflenet, shufflenetv2, mobilenet, mobilenetv2, efficientnet, mobilenetv2se
import ast
import numpy as np
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        resume_path_front_d = './checkpoints/best_model_' + args.model_type + '_front_IR.pth'
        resume_path_front_ir = './checkpoints/best_model_' + args.model_type + '_front_IR.pth'
        resume_path_top_d = './checkpoints/best_model_' + args.model_type + '_front_IR.pth'
        resume_path_top_ir = './checkpoints/best_model_' + args.model_type + '_front_IR.pth'
        ...
        normal_vec_front_d = normal_vec_front_ir
        ...
        #                                      args.feature_dim,
        #                                      args.use_cuda)
        normal_vec_top_d = normal_vec_front_ir
        ...
        #                                       args.feature_dim,
        #                                       args.use_cuda)
        normal_vec_top_ir = normal_vec_front_ir
